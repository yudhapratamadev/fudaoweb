...
export default function ReviewCard({ review }: { review: Review }) {
  return (
    <div className="rounded-3xl border border-rose/15 bg-white p-7 transition hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(201,125,140,.15)]">
      <div className="mb-3 tracking-[0.1em] text-rose">
        {"★".repeat(Math.max(0, Math.min(5, review.rating)))}
      </div>
      <p className="mb-5 font-serif text-lg italic leading-relaxed text-bark">
        "{review.text}"
      </p>
